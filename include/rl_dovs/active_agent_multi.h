...
class ActiveAgentMulti: public ActiveAgentClass {
private:
    ros::Subscriber ack_sub, collision_sub, reset_position_sub;
...
public:
    ...
    ActiveAgentMulti(int id, double v_x, double v_th, double x_goal, double y_goal, 
        ...
        bool two_lasers, bool collaborative_scenario, bool global_scenario, bool orca_agents, bool curricular_obstacles, bool curricular_goal,
        bool random_n_obstacles, bool static_obstacles, bool sac) : 
            ...
            { 
                ...
                if (test){
                    ...
                    if(global_scenario){
                        f_results_metrics_episode.open(ros::package::getPath("rl_dovs") + "/data/metrics/metrics_strategies_global_" + to_string(nActives)  + "-" + 
                        ...
                        f_results_metrics_episode.open(ros::package::getPath("rl_dovs") + "/data/metrics/metrics_collaborative_" + to_string(nActives)  + "-" + 
                                        to_string(nPasives) + "_" + to_string(id) + "_" + to_string(std::chrono::duration_cast<std::chrono::seconds>(
                                        p1.time_since_epoch()).count()) + ".txt", ios::app);
                    }
                    else {
                        f_results_metrics_episode.open(ros::package::getPath("rl_dovs") + "/data/metrics/metrics_strategies_1_laser_" + to_string(nActives)  + "-" + 
                                        to_string(nPasives) + "_" + to_string(id) + "_" + to_string(std::chrono::duration_cast<std::chrono::seconds>(
                                        p1.time_since_epoch()).count()) + ".txt", ios::app);
                    }
                }
                ...
                if (global_scenario){
                    ...
                    // std::cout << "Goal sent to global!!" <<  global_planner_goal_pub.getTopic() << std::endl;
                    // std::cout << "Goal sent to global!!" << std::endl;
                    // std::cout << "Goal sent to global!!" << std::endl;
                    // std::cout << "Goal sent to global!!" << std::endl;
                    // std::cout << "Goal sent to global!!" << std::endl;
                    // std::cout << "Goal sent to global!!" << std::endl;
                ...
                // if (id == 0){ 
                    // this->collision_sub = n.subscribe("near_robot_positions", 1, &ActiveAgentMulti::robotNearbyColl, this);
                    this->collision_sub = n.subscribe("collision", 1, &ActiveAgentMulti::collisionCall, this);
                // }
                this->position_sub = n.subscribe("amcl_pose", 1, &ActiveAgentMulti::positionChange, this);
                ...
                // this->ack_sub = n.subscribe("ack", 1, &ActiveAgentMulti::ackCallback, this);
